    ...
    <table style="border-collapse: collapse; border: 1px solid #ddd; width: auto; margin: 20px;">
        ...
        <tbody>
            <tr>
             ...
             <tr>
                <td style="border: 1px solid #ddd; padding: 8px;">Jeanpier Trujillo Mori</td>
                <td style="border: 1px solid #ddd; padding: 8px;">u201523565</td>
            </tr>
            <tr>
...
de audiencia</td>
            <td>Romina Tuesta <br> TB1: Para el desarrollo de la landing se tomaron en cuenta distintos aspectos dd la comunicación no oral, ya sean, textos, titulos, imagenes, etc. tuvimos todo en cuenta durante el desarrollo <br> TP1: Para esta entrega tuvimos en ceunta el desarrollo tetual del reporte, verificando la coherencia y ortografía de cada elemento. <br> <br>Abraam Acosta<br> TB1: Participé en sesiones grupales para definir objetivos y tareas del sprint. <br> TP1: Colaboré planificando tareas, cumplí con mis tareas asignadas en frontend a tiempo y ayudé a revisar errores del documento final para cumplir los objetivos del sprint.<br><br>Andy Mio<br> TB1: <br> TP1: <br> <br>Jeanpier Trujillo<br> TB1:Participé activamente en la exposición de ideas durante las reuniones del equipo, presentando propuestas claras sobre la funcionalidad de la plataforma. Me aseguré de que todos los miembros comprendieran el objetivo final, ajustando mi forma de comunicar según la necesidad del momento. <br> TP1:Durante la presentación del trabajo parcial, me enfoqué en explicar la arquitectura general del sistema de forma clara y estructurada, destacando los beneficios del enfoque usado y adaptándome al nivel técnico del público. <br> <br>Anderson Gonza<br> TB1: Apoye con la distribucion de obejtivos para cada uno de los integrantes, asi mismo entregando mis respectivas tareas asignadas. <br> TP1: Participe en las sesiones grupales para definir las correcciones. Asi como ayude en la correcion del documento tanto mis secciones como las de los compañeros. <br> <br>Jeanpier Trujillo <br> TB1:Contribuí a la redacción del Lean UX y el impact mapping, redactando los contenidos con un lenguaje accesible y coherente para facilitar la comprensión de los objetivos del proyecto. <br> TP1: Apoyé en la redacción del reporte, enfocándome en la claridad del contenido técnico y cuidando aspectos formales como ortografía, redacción y coherencia en las secciones asignadas. <br><br>Aldair Ramos<br> TB1:Partícipe de las reuniones para la asignación de responsabilidades. <br> TP1:Cumplí con mis objetivos propuestos para la entrega. </td>
            <td><br></td>
        </tr>
    </tbody>
</table>
...
<table>
  ...
  <tr>
    <td valign="top"><img src="./images/LogoEcoTrip.PNG" alt="Logo de EcoTrip" height="90px"></td>
